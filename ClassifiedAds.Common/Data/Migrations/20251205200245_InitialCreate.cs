    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DevicePublicKey", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DevicePublicKey_Members_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlaggedByUserId = table.Column<string>(type: "text", nullable: false),
                    FlaggedById = table.Column<string>(type: "text", nullable: true),
                    Reason = table.Column<string>(type: "text", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlaggedAds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlaggedAds_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlaggedAds_Members_FlaggedById",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin-id", "a3b7c24f-7e12-4b3a-9f5d-6e8f2a1b3c4d", "Admin", "ADMIN" },
                    { "member-id", "1ef432b8-2148-4d6a-9240-9a257206c87c", "Member", "MEMBER" },
                    { "moderator-id", "d5a6b89f-94d6-40d7-8e0e-7f0e9f3b4d1e", "Moderator", "MODERATOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DevicePublicKey_MemberId_DeviceId",
                table: "DevicePublicKey",
                columns: new[] { "MemberId", "DeviceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FlaggedAds_AdId",
                table: "FlaggedAds",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_FlaggedAds_FlaggedById",
                table: "FlaggedAds",
                column: "FlaggedById");
